...
class TestScraperCore:
    ...
    def test_default_instance(self):
        ...
        assert response.status_code == 200, response.content
        scraper_model = ScraperModel.model_validate(response.json())
        assert TestScraperCore.shared_values["default"] in scraper_model.browsers
        browser_model = scraper_model.browsers[TestScraperCore.shared_values["default"]]
        assert math.isclose(
    ...
    def test_explicit_instance(self):
        ...
        assert response.status_code == 200, response.content
        scraper_model = ScraperModel.model_validate(response.json())
        assert TestScraperCore.shared_values["explicit"] in scraper_model.browsers
        browser_model = scraper_model.browsers[
